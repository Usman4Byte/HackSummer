...
export interface AgentPlan {
  ...
  rawAnswer: string;   // what the agent WOULD say if unmonitored (may include leaked secret)
  safeAnswer: string;  // what the agent says once Sentinel has scrubbed / blocked
}
...
function truthPlan(prompt: string): AgentPlan {
  return {
    scenario: "truth",
    proposedCalls: [
